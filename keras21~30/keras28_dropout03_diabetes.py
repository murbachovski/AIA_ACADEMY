...
model = Sequential()
model.add(Dense(30, input_shape=(10, ))) #input_dim=13
...
mcp = ModelCheckpoint( #restore_best_weights=True가 들어가 있는 모델
    ...
    verbose=1,
    save_best_only=True,
    filepath= "".join([filepath, 'k28_dropout_diabetes', date, '_', filename])
)
...
model2 = load_model('_save\MCP\keras27_4\k28_dropout_diabetes0314_1249_0089-3727.8274.hdf5')
...
# loss: 3797.479736328125 acc: 0.0 r2: 0.2462392095406859
# loss: 4472.4658203125 acc: 0.0 r2: 0.11226151953716157
...
r2 = r2_score(y_test, y_predict)
print('loss:', results[0], 'acc:', results[1], 'r2:', r2)
# loss: 3815.2529296875 acc: 0.0 r2: 0.2427114299671267