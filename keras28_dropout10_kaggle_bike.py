...
mcp = ModelCheckpoint(
    ...
    mode='auto',
    save_best_only=True,
    filepath= "".join([filepath + 'k28_kaggle_bike', date, '_-_', filename]),
    verbose=1,
)
hist = model.fit(x_train, y_train, epochs = 1000, batch_size=50, verbose=1, validation_split=0.2, callbacks=[es, mcp])

model2 = load_model('_save\MCP\keras27_4\k28_kaggle_bike0314_1541_-_0006-24614.3047.hdf5')
