...
save_path= './_save/ai_factory/social/'

train_path='./_data/ai_factory/social/TRAIN/'
train_AWS_path='./_data/ai_factory/social/TRAIN_AWS/'

test_INPUT_path = './_data/ai_factory/social/TEST_INPUT/'
test_AWS_path = './_data/ai_factory/social/TEST_AWS/'
