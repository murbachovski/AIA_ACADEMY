...
def split_xy3(datasets, timesteps, y_column):
    x, y = list(), list()
    for i in range(len(datasets)):
        ...
        tmp_y = datasets[x_end_number : y_end_number]
        x.append(tmp_x)
        y.append(tmp_y)
    return np.array(x), np.array(y)

x, y = split_xy3(datasets, 13, 1)
# print(x, '\n', y)
# print(x.shape, y.shape) # (420538, 13, 14) (420538, 1, 14)
