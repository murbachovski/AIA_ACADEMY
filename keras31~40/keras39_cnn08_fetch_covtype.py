...
x_train = x_train.reshape(464809, 6, 9, 1)
x_test = x_test.reshape(116203, 6, 9, 1)

#2. MODEL
input1 = Input(shape=(6, 9, 1))
conv1 = Conv2D(16,(2,2), padding = 'same')(input1)
conv2 = Conv2D(32,(2,2),padding='same')(conv1)
...
output1 = Dense(8, activation='softmax')(drop1)
