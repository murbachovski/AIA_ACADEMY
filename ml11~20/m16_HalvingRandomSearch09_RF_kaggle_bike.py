...
#2. MODEL # 대문자 = class
model = HalvingGridSearchCV(RandomForestRegressor(), parameters, verbose=1, refit=True, n_jobs=-1, cv=5)
...
# HalvingGridSearchCV
# 최적의 매개변수 :  RandomForestRegressor(max_depth=6, min_samples_split=5, n_estimators=200)
# 최적의 파라미터 :  {'max_depth': 6, 'min_samples_split': 5, 'n_estimators': 200}
# 최적의 인덱스 :  32
# BEST SCORE :  0.3338232087369408
# model 스코어 :  0.3281887857743775
# 걸린 시간:  22.66 초
