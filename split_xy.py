...
dataset_h = pd.read_csv(path + '현대제철.csv', thousands=',', encoding='utf-8')
...
dense3 = Dense(16, activation='relu')(drop5)
output1 = Dense(8, activation='relu')(dense3)
...
output2 = Dense(16, activation='relu')(drop3)
...
hist = model.fit([x1_train, x2_train], y_train, epochs=100, batch_size=64, callbacks=[Es], validation_split=0.025)
end_time = time.time()

model.save('./_save/samsung/test_hyundai_kdj.h5')
#model = load_model()
# PREDICT
...
# 1. loss:  1235527.0 predict:  [[33928.58]]
# 2. loss:  1202460.75 predict:  [[34185.7]]