...
xy_train = train_datagen.flow_from_directory( 
    'd:/study_data/_data/horse_human/',
    target_size=(150,150),       
    batch_size= 2000,                    ###전체 데이터 쓸려면 160넣기(통배치)###
...
np.save(save_path + 'keras58_horse_human_x_train.npy', arr=x_train)
np.save(save_path + 'keras58_horse_human_x_test.npy', arr=x_test)
np.save(save_path + 'keras58_horse_human_y_train.npy', arr=y_train)  
np.save(save_path + 'keras58_horse_human_y_test.npy', arr=y_test) 
