...
x_train = np.load(save_path + 'keras58_horse_human_x_train.npy')
x_test = np.load(save_path + 'keras58_horse_human_x_test.npy')
y_train = np.load(save_path + 'keras58_horse_human_y_train.npy')
y_test = np.load(save_path + 'keras58_horse_human_y_test.npy')
...
'''
acc: 0.6063258647918701
val_acc: 0.7215189933776855
loss: 0.6840435266494751
val_loss: 0.6669294834136963
'''